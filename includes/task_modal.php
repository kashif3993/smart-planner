<div id="taskModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <button id="aiAutoFillBtn" class="ai-suggestion-btn" type="button" style="width: 100%; background: #fdf4ff; border: 1px solid #f0abfc; color: #c026d3; padding: 12px; border-radius: 8px; font-weight: 600; display: flex; align-items: center; justify-content: center; gap: 8px; cursor: pointer; margin-bottom: 20px; transition: all 0.2s;" onclick="autoFillTaskWithAI()">
